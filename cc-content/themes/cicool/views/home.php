   ...
   <header>
      <div class="header-content" >
         <div class="header-content-inner">
            <h1 id="homeHeading"><?= cclang('wellcome'); ?></h1>
            <hr>
            <p><?= cclang('institution'); ?></p>
            <a href="<?= site_url('administrator/login'); ?>" class="btn btn-primary btn-xl page-scroll"> <i class="fa fa-sign-in"></i> <?= cclang('login_system'); ?></a>
         </div>
      </div>
   </header>
   <!--
