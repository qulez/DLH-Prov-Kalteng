...
<head>
  ...
  <title>Dinas Lingkungan Hidup | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
                ...
                <img src="<?= BASE_ASSET; ?>/img/Logo_prov.png" width="100">
                  <h3><?php echo ('DINAS LINGKUNGAN HIDUP');?></h3>
                                <h4><span ><?php echo ('Provinsi Kalimantan Tengah');?></span></h4>
